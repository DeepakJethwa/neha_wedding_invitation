/**
 * @author Deepak Jethwa <deepakjethwa95@gmail.com>
 */
(function ($) {
    "use strict";
...
var x = setInterval(function() {
    ...
    document.getElementById("time").innerHTML = "<div class='container'><div id='days'>"+ days + "<br>Days</div>" + "<div id='hours'>" + hours + "<br>Hours</div>" + "<div id='minutes'>" + minutes + "<br>Minutes</div>" + "<div id='seconds'>" + seconds + "<br>Seconds</div></div>";
...
console.log('\n\n%c SAVE THE DATE: 26th Jan, 2022!', styles);

console.log('%cYour presence is requested!%c\n\nRegards: Deepak Jethwa', styles1, styles2);
